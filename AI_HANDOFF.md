...
7. **Kanban routing changed 2026-08-15:** Programmer, Tester, and Publisher now use local `custom:ollama / autoedit-qwen3.8:64k` with an explicitly verified 65,536-token active context; main, auxiliary, and delegation pins are aligned and fallback providers are empty. Designer is unchanged. Historical Codex/Luna/Tester-9Router route text is audit history. Read `docs/status/2026-08-15-kanban-qwen38-routing.md` before dispatch.
