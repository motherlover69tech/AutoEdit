...
2. **Open decision for Peter:** select the WhisperX candidate `01KZT3372CDNV7SBKK18STZRZ2` as the chosen cut (currently `selected=false`; VAD cut `01KXPJ...` v1 remains selected). One save-endpoint call when he decides.
